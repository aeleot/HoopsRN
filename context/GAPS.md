...
| [`gaps/ACCESSIBILITY.md`](gaps/ACCESSIBILITY.md) | No screen known to break at `.accessibility3` any more — `StatsCard`'s mid-word break and the map court card's truncated name both **closed 2026-09-22** and the pairings the suite doesn't assert. The brand-orange AA failure that used to lead this page **closed 2026-09-21**. |
